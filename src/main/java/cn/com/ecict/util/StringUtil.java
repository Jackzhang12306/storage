...
public class StringUtil {
    ...
    public static boolean isIP(String ip){
        if(StringUtil.isEmpty(ip) || ip.length()<7 || ip.length()>15)
            return false;
        //String regex="([1-9]|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])(\\.(\\d|[1-9]\\d|1\\d{2}|2[0-4]\\d|25[0-5])){3}";
        String regex="(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[5][0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[5][0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[5][0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(StringUtil.isIP("10.127.30.45"));
        System.out.println(StringUtil.isIP("10.127.30"));
        System.out.println(StringUtil.isIP("10.127.30.45.222"));
        System.out.println(StringUtil.isIP("255.255.256.45"));
        System.out.println(StringUtil.isIP("0.0.0.0"));
