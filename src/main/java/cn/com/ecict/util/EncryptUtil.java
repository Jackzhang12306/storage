...
public class EncryptUtil {
    ...
    public static void main(String[] args) {
        try {
            String message = "中国电科第32所版权所有,截止2017-05-20 00:00:00";
            ...
            resultBytes = EncryptUtil.encrypt(publicKey, srcBytes);
            String result = new String(resultBytes);
            System.out.println("用公钥加密后密文是:" + result);

            // return privateKey;
            // //用私钥解密
            byte[] decBytes = EncryptUtil.decrypt(privateKey,resultBytes);
